...
| Connections and Improvement | Proposed roots, visibly marked |
| Promoting | Original label retained; intended meaning unresolved; not silently equated with Prompting or marketing |
| Specific branches, system placements, perfection criteria, next investigations | Working proposals supported at their stated scope |
...
The current request governs the work. This contract and AGENTS.md express the current repository arrangement. Archived sources preserve evidence and earlier instructions without silently overriding this arrangement. New evidence can revise a placement, criterion, method, or question while preserving unaffected work.

Choose the next contribution from the actual situation. [NEXT.md](NEXT.md) contains prepared work, not a mandatory sequence. Exploration, changing frames, discovering goals, and inventing methods remain available. No finite inventory is an admission gate for new intellectual work.
