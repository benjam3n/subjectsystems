...
**Current scoped interpretation:** [M1 — Retention and recovery](../../../subjects/scopes/availability.md#m1-retention-and-recovery). Continuity with earlier material and its recovery. A memory-capacity claim uses B1. See the [complete scope mapping](../../../research/SCOPE-MAP.md). The older account below remains development material.
...
Retention and recovery of earlier work with the context needed for later use.
...
|---|---|---|---|
| [System Recovery](../../../systems/systemrecovery.md) | recovering earlier work | source-backed proposed placement | To customize for the stated purpose |
| [Project Dashboard](../../../systems/project-dashboard.md) | recovering run history | source-backed proposed placement | To customize for the stated purpose |
| [Historical AxiomNet](../../../systems/axiomnet-historical.md) | Retaining claim identity and justification for later recovery | proposed relevance; particular artifact and application to verify | To customize for the stated purpose |
| [GOSM](../../../systems/gosm.md) | Recovering project state, decisions, artifacts, and failures | proposed relevance; particular artifact and application to verify | To customize for the stated purpose |

## Frontier

Can earlier work be recovered with the distinctions and context needed for the present use?

Which omissions change a recovered item’s meaning despite identical text? How can a superseded proposal remain findable without regaining authority?

## Next substantive work

Recover one previously rejected proposal alongside the rejection and verify that a new use preserves both identities.
