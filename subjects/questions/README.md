...
What makes a question worth asking before its answer or eventual importance is known?

When does a follow-up question introduce uncertainty rather than rephrase the previous one? Which unasked question would change the current route most?

## Next substantive work

Build an answer-dependent continuation for a live question and preserve the cases that require different next inquiries.
