...
**Current scoped interpretation:** [R3 — Courses and contingencies](../../../subjects/scopes/arrangements.md#r3-courses-and-contingencies). Shares course structure with Planning. Context, horizon, and branching remain attributes until a further exclusive distinction is established. See the [complete scope mapping](../../../research/SCOPE-MAP.md). The older account below remains development material.
...
Approaches within contexts involving objectives, responses, constraints, and adaptation.
...
|---|---|---|---|
| [ARAW](../../../systems/araw.md) | consequences of possible approaches | source-backed proposed placement | To customize for the stated purpose |
| [Strategizer / current AxiomNet transition](../../../systems/strategizer.md) | approaches and counterplay | source-backed proposed placement | To customize for the stated purpose |
| [GOSM](../../../systems/gosm.md) | Developing approaches through goal relationships and future consequences | proposed relevance; particular artifact and application to verify | To customize for the stated purpose |

## Frontier

Under which conditions does the approach succeed, and which response by another actor defeats it?

Which response by another actor defeats an otherwise successful approach? When does a change of context require a new strategy rather than a variant?

## Next substantive work

Develop a context-specific approach with its entry conditions, counterplay, and a distinct alternative.
