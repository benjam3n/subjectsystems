...
**Current scoped interpretation:** [R4 — Resource feasibility](../../../subjects/scopes/arrangements.md#r4-resource-feasibility). Feasibility of configurations relative to use, access, and capacity; not an intrinsic category of every useful thing. See the [complete scope mapping](../../../research/SCOPE-MAP.md). The older account below remains development material.
...
Available means, possible uses, allocation, constraints, and configurations that change what can be done.
...
|---|---|---|---|
| [Resource-engineering](../../../systems/resource-engineering.md) | allocation and configurations | source-backed proposed placement | To customize for the stated purpose |
| [BOD](../../../systems/bod.md) | capability conditions | source-backed proposed placement | To customize for the stated purpose |
| [GOSM](../../../systems/gosm.md) | Assessing the means and feasibility conditions required by a goal | proposed relevance; particular artifact and application to verify | To customize for the stated purpose |

## Frontier

Which change in resources or their arrangement makes a previously unavailable result possible?

When does rearranging existing resources create a new capability? Which apparent limitation is actually a selection or configuration error?

## Next substantive work

Reconstruct a capability gap in terms of available means, alternative uses, constraints, and a candidate configuration change.
