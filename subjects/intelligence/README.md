...
|---|---|---|
| [Reasoningtool2](../../systems/reasoningtool2.md) | making available capability usable | source-backed proposed placement |
| [Superintelbot](../../systems/superintelbot.md) | selecting appropriate work | source-backed proposed placement |
| [BOD](../../systems/bod.md) | Separating described capability from capability realized in context | proposed relevance; particular artifact and application to verify |
| [Resource-engineering](../../systems/resource-engineering.md) | Relating resource availability, configuration, and actual use | proposed relevance; particular artifact and application to verify |
| [PostAGI reasoning](../../systems/postagi-reasoning.md) | Investigating how different representations make work available | proposed relevance; particular artifact and application to verify |
