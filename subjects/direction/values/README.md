...
Worth, importance, and the grounds on which purposes or alternatives merit pursuit.
...
|---|---|---|---|
| [Autophilosophy](../../../systems/autophilosophy.md) | Examining standards of worth through conceptual investigations | proposed relevance; particular artifact and application to verify | To customize for the stated purpose |
| [GOSM](../../../systems/gosm.md) | Examining higher purposes through goal journeys | proposed relevance; particular artifact and application to verify | To customize for the stated purpose |
| [Reasoningtool](../../../systems/reasoningtool.md) | Retrieving relevant philosophy and regress procedures for examining standards | proposed relevance; particular artifact and application to verify | To customize for the stated purpose |

## Frontier

What would justify a standard of worth when the candidate standards themselves disagree?

Can two conflicting standards be compared without quietly adopting one of them? Which changes in a value judgment follow from new facts and which change the standard itself?

## Next substantive work

Develop a real conflict between two purposes and identify where disagreement concerns facts, consequences, or standards of worth.
