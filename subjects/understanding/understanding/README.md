...
Accounts and distinctions that make a subject more intelligible and permit further work with it.
...
|---|---|---|---|
| [Master Framework](../../../systems/master-framework.md) | common structure across subjects | unresolved source; tentative placement | To customize for the stated purpose |
| [LogicSystem](../../../systems/logicsystem.md) | functional and causal decomposition | source-backed proposed placement | To customize for the stated purpose |
| [PostAGI reasoning](../../../systems/postagi-reasoning.md) | interacting concepts | source-backed proposed placement | To customize for the stated purpose |
| [Autophilosophy](../../../systems/autophilosophy.md) | Developing competing accounts through answer–attack–revision work | proposed relevance; particular artifact and application to verify | To customize for the stated purpose |

## Frontier

Which new inferences or interventions become possible when understanding improves?

Can a new frame improve understanding without adding facts? Which differences between two accounts produce different inferences or interventions?

## Next substantive work

Reconstruct one subject through two substantially different frames and identify a consequence available in only one account.
