...
**Current scoped interpretation:** [A3 — Explanatory relations](../../../subjects/scopes/accounts.md#a3-explanatory-relations). The explanatory relation. Grounds, expression, and usable grasp use A2, E1, and B1. See the [complete scope mapping](../../../research/SCOPE-MAP.md). The older account below remains development material.
...
What accounts for an event, contrast, mechanism, or pattern beyond restating it.
...
|---|---|---|---|
| [BOD](../../../systems/bod.md) | causal hypotheses | source-backed proposed placement | To customize for the stated purpose |
| [LogicSystem](../../../systems/logicsystem.md) | Reconstructing functions and candidate mechanisms | proposed relevance; particular artifact and application to verify | To customize for the stated purpose |
| [ARAW](../../../systems/araw.md) | Constructing and challenging competing explanations | proposed relevance; particular artifact and application to verify | To customize for the stated purpose |
| [Superintelbot](../../../systems/superintelbot.md) | Selecting an explanatory contribution appropriate to the interaction | proposed relevance; particular artifact and application to verify | To customize for the stated purpose |

## Frontier

What does an explanation account for that a description or restatement leaves unresolved?

Which explanatory difference changes a prediction or intervention? When does an analogy generate a hypothesis without supplying evidence for it?

## Next substantive work

Develop competing explanations of a particular missed contribution and identify an observation on which they disagree.
