...
**Current scoped interpretation:** [E2 — Communicative uptake](../../../subjects/scopes/expression.md#e2-communicative-uptake); [Q1 — Question specification](../../../subjects/scopes/questions.md#q1-question-specification); [E1 — Encoding and textual arrangement](../../../subjects/scopes/expression.md#e1-encoding-and-textual-arrangement); [R3 — Courses and contingencies](../../../subjects/scopes/arrangements.md#r3-courses-and-contingencies). Instruction interpretation, question content, expression, course structure, and execution are different determinations within prompt development. See the [complete scope mapping](../../../research/SCOPE-MAP.md). The older account below remains development material.
...
How instructions and conversational conditions change the work a model performs.
...
- Changing the model’s starting conditions.
...
|---|---|---|---|
| [Reasoningtool2](../../../systems/reasoningtool2.md) | specifying intellectual work | source-backed proposed placement | To customize for the stated purpose |
| [Superintelbot](../../../systems/superintelbot.md) | instructions governing interaction | source-backed proposed placement | To customize for the stated purpose |
| [Reasoningtool](../../../systems/reasoningtool.md) | Specifying intellectual work through source skill prompts | proposed relevance; particular artifact and application to verify | To customize for the stated purpose |

## Frontier

Which parts of the desired intellectual work can an instruction reliably determine, and which require subsequent judgment?

Which part of anticipation changes selection before an answer is written? When does an exclusion constraint generate a different contribution rather than cosmetic novelty?

## Next substantive work

Develop the continuation-exclusion case in experiments.md and retain the prompt, selected operation, and resulting contribution.
